/**
 * @Title:selectGroupFrm.java
 * @Package:com.client.view
 * @Description:TODO(描述该文件做什么)
 * @author:  ShiLuoDeQin 
 * @date:2014-1-5下午11:26:43
 * @version V1.0
 */
...
/**
 * @ClassName:selectGroupFrm
 * @author Administrator
 * @Description:TODO(显示选择分组信息)
 * @date 2014-1-5 下午11:26:43
 *
 */
...
public class selectGroupFrm extends JFrame{
	 ...
	 int Mwide=360,Mheight=200;//窗体的长宽
		...
		public selectGroupFrm(final J_MainFrm JMain,final findFriendFrm MainFrm){
