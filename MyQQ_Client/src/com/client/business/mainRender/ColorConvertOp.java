/**
 * @Title:ColorConvertOp.java
 * @Package:图片灰显测试
 * @Description:TODO(描述该文件做什么)
 * @author:  ShiLuoDeQin 
 * @date:2013-12-30下午06:19:01
 * @version V1.0
 */
...
/**
 * @ClassName:ColorConvertOp
 * @author Administrator
 * @Description:TODO(描述这个类的作用)
 * @date 2013-12-30 下午06:19:01
 *
 */
...
public class ColorConvertOp {
	...
	//	originalPic=ImageIO.read(getClass().getResource(path));//获取图片存放人BufferedImage中
